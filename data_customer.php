                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="responsive">
                                ...
                                <?php
                                $query_data_customer = "SELECT * FROM customer";
                                $sql_data_customer = mysqli_query($conn, $query_data_customer);
                                $no = 1;
                                ?>
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody align="center">
                                    <?php
                                        while($r_dt_customer = mysqli_fetch_array($sql_data_customer)){
                                    ?>
                                        <tr class="odd gradeX">
