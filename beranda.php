        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <section class="mar-top--x-3 mar-bottom--x-5">
                    <div class="container">
                        <center>
                            <h1 class="h3 mb-0 text-gray-800">INGIN RENTAL ALAT GUNUNG? DISINI AJA</h1>
                        </center>
                    </div>
                    <br>
                    <div class="container">      
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/pendaki.png" class="d-block w-100" alt="gambar">
                            </div>
                            <div class="carousel-item">
                                <img src="img/tools.png" class="d-block w-100" alt="gambar">
                            </div>
                            <div class="carousel-item">
                                <img src="img/tent.png" class="d-block w-100" alt="gambar">
                            </div>
                            <div class="carousel-item">
                                <img src="img/sleeping bag.png" class="d-block w-100" alt="gambar">
                            </div>
                        </div>
